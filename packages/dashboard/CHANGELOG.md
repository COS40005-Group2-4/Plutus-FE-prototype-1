...
* custom slot background added
* grid lines parameters fixed 
* scroll to recently added item support added
* preventing drag outside of dashboard added
* empty placeholder fixed
