...
class EditModeSettings {
  ...
  /// Enable widget swap on drag-over in edit mode.
  /// When true, dragging a widget over another will swap their positions
  /// (or auto-relocate the target if sizes don't fit).
