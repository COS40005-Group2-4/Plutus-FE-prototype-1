...
class _DashboardItemWidgetState extends State<_DashboardItemWidget>
  ...
  void dispose() {
    ...
    widget.itemCurrentLayout._isSwapTarget.removeListener(_swapListen);
    super.dispose();
  }
  ...
  void initState() {
    ...
    widget.itemCurrentLayout._isSwapTarget.addListener(_swapListen);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Swap target highlight: scale down + colored border
    final isSwapTarget = widget.itemCurrentLayout._isSwapTarget.value;
    if (isSwapTarget) {
