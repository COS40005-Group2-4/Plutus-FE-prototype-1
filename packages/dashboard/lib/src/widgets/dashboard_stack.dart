      ...
      if (_editingResize) {
        ...
        if (resizeMoveResult != null && resizeMoveResult.isChanged) {
          setState(() {
            ...
            // Also rebuild widgets affected by a swap
            if (resizeMoveResult.affectedIds != null) {
              for (var affectedId in resizeMoveResult.affectedIds!) {
                _widgetsMap.remove(affectedId);
              }
            }
